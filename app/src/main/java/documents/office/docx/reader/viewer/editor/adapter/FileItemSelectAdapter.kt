...
import documents.office.docx.reader.viewer.editor.databinding.ItemPdfFileBinding
...
import documents.office.docx.reader.viewer.editor.databinding.ItemSelectFileBinding
import java.util.Locale

class FileItemSelectAdapter(
    context: Context,
    list: List<FileModel>,
...
) : BaseRecyclerAdapter<FileModel, FileItemSelectAdapter.ViewHolder>(context, list) {
    ...
    inner class ViewHolder(
        var binding: ItemSelectFileBinding
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding = ItemSelectFileBinding.inflate(layoutInflater, parent, false)
